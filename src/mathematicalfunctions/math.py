...
df.select("name", exp("number").alias("exp_value")).show()
df.select("name", log("number").alias("log_value")).show()
df.select("name", power("number", 2).alias("square")).show()
df.select("name", sqrt("number").alias("square_root")).show()